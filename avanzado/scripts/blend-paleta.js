...
function getStyles(s, elInputValue, thisColor, radioValue) {
  ...
  s.textContent =
    "input[type=range]::-webkit-slider-runnable-track{background:-webkit-linear-gradient(0deg, transparent " +
    elInputValue +
    "%, " +
    thisColor +
    " " +
    elInputValue +
    "%),0% 0% no-repeat  border-box url(http://c1.staticflickr.com/5/4049/4545882390_a5c0128dda_z.jpg);background-blend-mode: " +
    radioValue +
    ";}\n";
  s.textContent +=
    "input[type=range]::-moz-range-track{background:-moz-linear-gradient(0deg, transparent " +
    elInputValue +
    "%, " +
    thisColor +
    " " +
